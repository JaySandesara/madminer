...
C     
C     Process: g g > h > e+ e- e+ e- g NP<=2 QCD<=5 QED<=4
C      WEIGHTED<=28 [ all = QCD ]
C     Process: g g > h > mu+ mu- mu+ mu- g NP<=2 QCD<=5 QED<=4
C      WEIGHTED<=28 [ all = QCD ]
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL VVV3P0_1(W(1,1),W(1,2),GC_10,ZERO,ZERO,W(1,8))
      CALL FFV12_2_3(W(1,3),W(1,4),GC_317,GC_243,MDL_MZ,MDL_WZ,W(1,9))
      CALL FFV12_2_3(W(1,5),W(1,6),GC_317,GC_243,MDL_MZ,MDL_WZ,W(1,10))
      CALL VVS4_3(W(1,8),W(1,7),GC_426,MDL_MH,MDL_WH,W(1,11))
C     Amplitude(s) for diagram number 1
      CALL VVS3_0(W(1,9),W(1,10),W(1,11),GC_588,AMP(1))
      CALL FFV12_2_3(W(1,3),W(1,6),GC_317,GC_243,MDL_MZ,MDL_WZ,W(1,8))
      CALL FFV12_2_3(W(1,5),W(1,4),GC_317,GC_243,MDL_MZ,MDL_WZ,W(1,6))
C     Amplitude(s) for diagram number 2
      CALL VVS3_0(W(1,8),W(1,6),W(1,11),GC_588,AMP(2))
      CALL VVV3P0_1(W(1,1),W(1,7),GC_10,ZERO,ZERO,W(1,11))
      CALL VVS4_3(W(1,11),W(1,2),GC_426,MDL_MH,MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL VVS3_0(W(1,9),W(1,10),W(1,5),GC_588,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL VVS3_0(W(1,8),W(1,6),W(1,5),GC_588,AMP(4))
      CALL VVV3P0_1(W(1,2),W(1,7),GC_10,ZERO,ZERO,W(1,5))
      CALL VVS4_3(W(1,1),W(1,5),GC_426,MDL_MH,MDL_WH,W(1,11))
C     Amplitude(s) for diagram number 5
      CALL VVS3_0(W(1,9),W(1,10),W(1,11),GC_588,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL VVS3_0(W(1,8),W(1,6),W(1,11),GC_588,AMP(6))
      CALL VVVS9_4(W(1,1),W(1,2),W(1,7),GC_457,MDL_MH,MDL_WH,W(1,11))
C     Amplitude(s) for diagram number 7
      CALL VVS3_0(W(1,9),W(1,10),W(1,11),GC_588,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL VVS3_0(W(1,8),W(1,6),W(1,11),GC_588,AMP(8))
