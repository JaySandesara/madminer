...
C     
      SUBROUTINE FFV10L2_1(P2, V3, COUP, M1, W1, P1, COEFF)
      IMPLICIT NONE
      COMPLEX*16 CI
     ...
     $ )+CI*(V3(8))))))
      COEFF(2,0,1)= COUP*(P1(0)*(-1D0)*(V3(7)+CI*(V3(6)))+(P1(1)*(-CI
     ...
     $ )))))
      ...
      COEFF(2,1,1)= COUP*(-1D0)*(V3(7)+CI*(V3(6)))
      COEFF(3,1,1)= 0D0
      COEFF(4,1,1)= 0D0
      COEFF(1,2,1)= COUP*(-1D0)*(V3(7)+CI*(V3(6)))
      COEFF(2,2,1)= COUP*(-CI*(V3(8))+CI*(V3(5)))
      COEFF(3,2,1)= 0D0
      COEFF(4,2,1)= 0D0
      COEFF(1,3,1)= COUP*(-1D0)*(+CI*(V3(7))-V3(6))
