...
C     
      SUBROUTINE MP_FFV10L1_2(P1, V3, COUP, M2, W2, P2, COEFF)
      IMPLICIT NONE
      COMPLEX*32 CI
     ...
     $ +V3(8)))+(P2(2)*(-1Q0)*(V3(5)+V3(8))+P2(3)*(V3(7)-CI*(V3(6))))))
      ...
      COEFF(3,4,1)= 0Q0
      COEFF(4,4,1)= 0Q0
      COEFF(1,0,2)= COUP*(P2(0)*(-1Q0)*(V3(7)+CI*(V3(6)))+(P2(1)*(-CI
     ...
     $ *(V3(8))))))
      ...
      COEFF(1,1,2)= COUP*(-1Q0)*(V3(7)+CI*(V3(6)))
     ...
     $ +CI*(V3(8)))+(P2(2)*(V3(5)-V3(8))+P2(3)*(V3(7)-CI*(V3(6))))))
      ...
      COEFF(3,0,4)= COUP*(P2(0)*(V3(7)+CI*(V3(6)))+(P2(1)*(-1Q0)*(+CI
     $ *(V3(5)+V3(8)))+(P2(2)*(-1Q0)*(V3(5)+V3(8))+P2(3)*(V3(7)+CI
     $ *(V3(6))))))
      COEFF(4,0,4)= COUP*(P2(0)*(-1Q0)*(+CI*(V3(5)+V3(8)))+(P2(1)
