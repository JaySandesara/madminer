...
C     
      SUBROUTINE MP_VVS3_6_0(V1, V2, S3, COUP1, COUP2,VERTEX)
      IMPLICIT NONE
      COMPLEX*32 CI
      ...
      VERTEX = -1Q0/2Q0 * S3(5)*(COUP2*(TMP13*(-CI*(TMP2)+CI*(TMP14
     $ +TMP15)+2Q0 * CI*(TMP16))+(TMP11*(-CI*(TMP9)+2Q0 * CI*(TMP8))
     $ -CI*(TMP8*TMP12)))+2Q0 * CI*(TMP13*COUP1))
      END
