...
C     
C     Process: g g > h > e+ e- e+ e- NP<=2 QCD=0 QED<=4 WEIGHTED<=18 [
C      all = QCD ]
C     Process: g g > h > mu+ mu- mu+ mu- NP<=2 QCD=0 QED<=4
C      WEIGHTED<=18 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV12_2_3(W(1,3),W(1,4),GC_317,GC_243,MDL_MZ,MDL_WZ,W(1,2))
      CALL FFV12_2_3(W(1,5),W(1,6),GC_317,GC_243,MDL_MZ,MDL_WZ,W(1,1))
C     Amplitude(s) for diagram number 1
      CALL VVS3_0(W(1,2),W(1,1),W(1,7),GC_588,AMP(1))
...
C     Amplitude(s) for diagram number 2
      CALL VVS3_0(W(1,1),W(1,6),W(1,7),GC_588,AMP(2))
C     JAMPs contributing to orders QCD=0
      JAMP(1,1)=+2D0*(+AMP(1)-AMP(2))
