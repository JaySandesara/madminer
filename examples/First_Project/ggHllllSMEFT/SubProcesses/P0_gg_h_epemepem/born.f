...
C     
C     Process: g g > h > e+ e- e+ e- NP<=2 QCD<=4 QED<=4 [ all = QCD ]
C     Process: g g > h > mu+ mu- mu+ mu- NP<=2 QCD<=4 QED<=4 [ all =
C      QCD ]
C     
      IMPLICIT NONE
C     
...
C     
      ...
      DATA IDEN_VALUES /1024, 1024, 1024, 1024, 1024, 1024/
      INTEGER IJ_VALUES(6)
      ...
      DO IHEL=BACK_HEL,-BACK_HEL,STEP_HEL
        ...
        IF (COND_IJ) THEN
          ...
          IF (.NOT. CALCULATEDBORN) THEN
            ...
            CALL FFV12_2_3(W(1,3),W(1,4),GC_317,GC_243,MDL_MZ,MDL_WZ
     $       ,W(1,2))
            CALL FFV12_2_3(W(1,5),W(1,6),GC_317,GC_243,MDL_MZ,MDL_WZ
     $       ,W(1,1))
C           Amplitude(s) for diagram number 1
            CALL VVS3_0(W(1,2),W(1,1),W(1,7),GC_588,AMP(1))
            CALL FFV12_2_3(W(1,3),W(1,6),GC_317,GC_243,MDL_MZ,MDL_WZ
     $       ,W(1,1))
            CALL FFV12_2_3(W(1,5),W(1,4),GC_317,GC_243,MDL_MZ,MDL_WZ
     $       ,W(1,6))
