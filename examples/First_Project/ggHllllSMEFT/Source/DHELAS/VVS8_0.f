...
C     
      ...
      VERTEX = COUP*(-13D0/62D0 * S3(5)*(TMP13*23D0/13D0*(-40D0/23D0 *
     $  CI*(TMP2)+19D0/23D0 * CI*(TMP14)+CI*(TMP16)+4D0/23D0 * CI
     $ *(TMP15)-13D0/23D0 * CI*(TMP17))+(TMP11*(-CI*(TMP9)+62D0/13D0 *
     $  CI*(TMP8))+TMP12*(-CI*(TMP8)+1D0/13D0 * CI*(TMP9)))))
      END
