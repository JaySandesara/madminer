...
C     P(1,2)*P(2,1) - (P(-1,1)*P(-1,2)*Metric(1,2))/2. +
C      (P(-1,2)**2*Metric(1,2))/2. + (P(-1,2)*P(-1,3)*Metric(1,2))/2.
C     
      SUBROUTINE MP_VVS5_0(V1, V2, S3, COUP,VERTEX)
      IMPLICIT NONE
      COMPLEX*32 CI
      ...
      VERTEX = COUP*(-1Q0/2Q0 * S3(5)*(TMP13*(-CI*(TMP2)+CI*(TMP14
     $ +TMP16))+2Q0 * CI*(TMP8*TMP11)))
      END
