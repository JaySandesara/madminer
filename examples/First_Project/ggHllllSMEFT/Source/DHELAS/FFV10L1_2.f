...
C     
      SUBROUTINE FFV10L1_2(P1, V3, COUP, M2, W2, P2, COEFF)
      IMPLICIT NONE
      COMPLEX*16 CI
     ...
     $ +V3(8))))))
      COEFF(2,0,1)= COUP*(P2(0)*(V3(7)-CI*(V3(6)))+(P2(1)*(+CI*(V3(5)
     $ +V3(8)))+(P2(2)*(-1D0)*(V3(5)+V3(8))+P2(3)*(V3(7)-CI*(V3(6))))))
      ...
      COEFF(3,4,1)= 0D0
      COEFF(4,4,1)= 0D0
      COEFF(1,0,2)= COUP*(P2(0)*(-1D0)*(V3(7)+CI*(V3(6)))+(P2(1)*(-CI
     $ *(V3(8))+CI*(V3(5)))+(P2(2)*(V3(5)-V3(8))+P2(3)*(V3(7)+CI*(V3(6)
     $ )))))
      COEFF(2,0,2)= COUP*(P2(0)*(-CI*(V3(5))+CI*(V3(8)))+(P2(1)*(V3(7)
     $ +CI*(V3(6)))+(P2(2)*(+CI*(V3(7))-V3(6))+P2(3)*(-CI*(V3(5))+CI
     $ *(V3(8))))))
      COEFF(3,0,2)= COUP*M2*(V3(7)+CI*(V3(6)))
      COEFF(4,0,2)= COUP*M2*(-CI*(V3(8))+CI*(V3(5)))
      COEFF(1,1,2)= COUP*(-1D0)*(V3(7)+CI*(V3(6)))
      COEFF(2,1,2)= COUP*(-CI*(V3(5))+CI*(V3(8)))
      COEFF(3,1,2)= 0D0
      COEFF(4,1,2)= 0D0
      COEFF(1,2,2)= COUP*(-CI*(V3(8))+CI*(V3(5)))
      COEFF(2,2,2)= COUP*(V3(7)+CI*(V3(6)))
      COEFF(3,2,2)= 0D0
      COEFF(4,2,2)= 0D0
      COEFF(1,3,2)= COUP*(V3(5)-V3(8))
      COEFF(2,3,2)= COUP*(+CI*(V3(7))-V3(6))
      COEFF(3,3,2)= 0D0
      COEFF(4,3,2)= 0D0
      COEFF(1,4,2)= COUP*(V3(7)+CI*(V3(6)))
      COEFF(2,4,2)= COUP*(-CI*(V3(5))+CI*(V3(8)))
      COEFF(3,4,2)= 0D0
      COEFF(4,4,2)= 0D0
      COEFF(1,0,3)= COUP*M2*(-CI*(V3(8))+CI*(V3(5)))
     ...
     $ +CI*(V3(8)))+(P2(2)*(V3(5)-V3(8))+P2(3)*(V3(7)-CI*(V3(6))))))
      COEFF(1,1,3)= 0D0
      COEFF(2,1,3)= 0D0
      ...
      COEFF(3,0,4)= COUP*(P2(0)*(V3(7)+CI*(V3(6)))+(P2(1)*(-1D0)*(+CI
     $ *(V3(5)+V3(8)))+(P2(2)*(-1D0)*(V3(5)+V3(8))+P2(3)*(V3(7)+CI
     $ *(V3(6))))))
      COEFF(4,0,4)= COUP*(P2(0)*(-1D0)*(+CI*(V3(5)+V3(8)))+(P2(1)
     $ *(V3(7)+CI*(V3(6)))+(P2(2)*(+CI*(V3(7))-V3(6))+P2(3)*(+CI*(V3(5)
     $ +V3(8))))))
      COEFF(1,1,4)= 0D0
      COEFF(2,1,4)= 0D0
      COEFF(3,1,4)= COUP*(V3(7)+CI*(V3(6)))
      COEFF(4,1,4)= COUP*(-1D0)*(+CI*(V3(5)+V3(8)))
      COEFF(1,2,4)= 0D0
      COEFF(2,2,4)= 0D0
      COEFF(3,2,4)= COUP*(-1D0)*(+CI*(V3(5)+V3(8)))
      COEFF(4,2,4)= COUP*(V3(7)+CI*(V3(6)))
      COEFF(1,3,4)= 0D0
      COEFF(2,3,4)= 0D0
      COEFF(3,3,4)= COUP*(-V3(5)-V3(8))
      COEFF(4,3,4)= COUP*(+CI*(V3(7))-V3(6))
      COEFF(1,4,4)= 0D0
      COEFF(2,4,4)= 0D0
      COEFF(3,4,4)= COUP*(V3(7)+CI*(V3(6)))
